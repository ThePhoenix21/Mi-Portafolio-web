...
const ProjectsSection: React.FC = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Advanced analytics platform using machine learning to provide actionable insights from complex datasets.',
    ...
    },
    {
      ...
      description: 'Cross-platform social networking application with real-time messaging and content sharing capabilities.',
